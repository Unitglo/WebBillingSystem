<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CA_file_upload_code.aspx.cs" Inherits="WebBillingSystem.CA_file_upload_code" %>
...
<form id="uploadForm" action="http://pms.unitglo.com/send_to_ca.php" method="post">
    <div>
        <label>Upload Image File:</label>
        <input name="user_file" id="user_file" type="file" class="demoInputBox" />
        <input name="ca_code" id="ca_code" type="text" />
    </div>
