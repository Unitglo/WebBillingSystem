...
{
    public partial class PurchaseReturnPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            while (reader2 != null && reader2.Read())
            {
                ...
                rows += "<tr><td style='border: 1px solid!important; '>" +i+ "</td>" +
                            ...
                            "<td style = 'border: 1px solid!important; ' class='tax - value'>" + reader2["igst_rate"].ToString() + "</td>" +
                            "<td style = 'border: 1px solid!important; ' class='tax - value'>" + reader2["igst_amount"].ToString() + "</td>" +
