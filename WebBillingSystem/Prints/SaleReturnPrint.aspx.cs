...
{
    public partial class SaleReturnPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                bill_to_party_name.InnerText = reader["bill_party_name"].ToString();
                ...
                headeragainst_invoice.InnerHtml = reader["against_invoice"].ToString();
                ...
                date_of_invoice.InnerText = reader["doc_state_code"].ToString();
            ...
            while (reader2 != null && reader2.Read())
            {
                ...
                rows += "<tr><td style='border: 1px solid!important; '>"+i+"</td>" +
                            ...
                            "<td style = 'border: 1px solid!important; ' class='igst - rate'>" + reader2["igst_amount"].ToString() + "</td>" +
