<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMainPage.Master" AutoEventWireup="true" CodeBehind="SalesQuotation.aspx.cs" Inherits="WebBillingSystem.SalesQuotation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>Create Sales Order Quotation</h2>
    <input type="date" style="float: right" runat="server" id="dates" />
    <table style="width: 80%;">
        <tr>
            <td>PO NO. : </td>
            <td>
                <asp:Label ID="PONo" runat="server" Text="1"></asp:Label></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="SupplierNameList" runat="server" AutoPostBack="True" Width="150">
                    <asp:ListItem Text="Select Any Supplier" Value="0">Select Any Customer</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:DropDownList ID="VatTypeList" runat="server" Width="150">
                    ...
                    <asp:ListItem Text="VAT" Value="0.125"></asp:ListItem>
    ...
    <table style="width: 80%;">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate11" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate1" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate12" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate2" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate13" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate3" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate14" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate4" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate15" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate5" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate16" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate6" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate17" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate7" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate18" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate8" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate19" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate9" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Rate110" runat="server" Text="0"></asp:Label><br />
                <asp:TextBox ID="Rate10" runat="server" Text="0" onkeypress="CheckNumeric(event);"></asp:TextBox>
            </td>
    ...
    <div style="float: right; text-align: right;">
        <table>
            <tr>
                ...
                <td>:</td>
                <td>
                    <asp:Label ID="VatTotal" runat="server" Text="0000.00"></asp:Label></td>
            </tr>
            <tr>
                <td>Total</td>
                <td>: </td>
                <td>
                    <asp:Label ID="TotalAmount" runat="server" Text="0000.00"></asp:Label></td>
            </tr>
        </table>
