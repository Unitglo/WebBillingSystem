<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="company_file_upload_code.aspx.cs" Inherits="WebBillingSystem.company_file_upload_code" %>
...
<form id="uploadForm" action="http://pms.unitglo.com/send_to_company.php" method="post" runat="server">
    <div>
        <label>Upload Image File:</label>
        <asp:FileUpload ID="FileUpload1" runat="server" />
        <input name="user_file_name" id="user_file" type="file" runat="server" class="demoInputBox"/>
        <input name="company_code" id="company_code" type="text" />
    </div>
