<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreditNotePrint.aspx.cs" Inherits="WebBillingSystem.CreditNotePrint" %>
<html>

    <table style="width: 100%;text-align:center">
       
       <tr><td>
             <b style="font-size:larger"> <label runat="server" id="name" /></b>
         </td></tr>
        <tr><td>
                ...
                <table style="width: 100%; text-align: left;">
                                        ...
                                        <tbody><tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">:
                                                <label runat="server" id="bill_party_name" />     
                                                </td><td></td><td></td>
                                           </tr>
                                            <tr>
                                                <td colspan="4">
 ...
 <table class="table table-light table-bordered mb-0 table-responsive" id="myTable" style="border: 1px solid; width: 100%;">
                    ...
                    <td style="border:1px solid!important;" class="igst-rate">6.00</td>
                            <td style="border:1px solid!important;" class="igst-amount">6.00</td>
                            ...
                            <td style="border:1px solid!important;" class="tot_class">86800.00</td>
						</tr></tbody>
                     ...
                     <tr>
                      ...
                      <tr>
                          ...
                          <th id="tot_amt_aftertax" runat="server" class="text-right font-weight-600" style="border: 2px solid">00.00</th>
                      </tr>
