<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DebitNotePrint.aspx.cs" Inherits="WebBillingSystem.DebitNotePrint" %>
<html>
 ...
 <table class="table table-light table-bordered mb-0 table-responsive" id="myTable" style="border: 1px solid; width: 100%;">
						...
						<tr><td style="border:1px solid!important;">1</td>
                            ...
                            <td style="border:1px solid!important;" class="amount">1205097.24</td>
                            <td style="border:1px solid!important;" class="discount">0.00</td>
                            <td style="border:1px solid!important;" class="tax-value">1205097.24</td>
                    <td style="border:1px solid!important;" class="igst-rate">6</td>
                            <td style="border:1px solid!important;" class="igst-amount">0.00</td>
                            <td style="border:1px solid!important;" class="cgst-rate">6</td>
                            <td style="border:1px solid!important;" class="cgst-amount">0.00</td>
                            <td style="border:1px solid!important;" class="sgst-rate">6</td>
                            <td style="border:1px solid!important;" class="sgst-amount">0</td>
                            <td style="border:1px solid!important;" class="tot_class">1349708.91</td>
						</tr></tbody>
                      ...
                      <tr>
                          ...
                          <th id="tot_row_Quant" runat="server" colspan="1" class="text-right font-weight-600" style="border: 2px solid">4.00</th>
                          <th id="tot_row_Rat" runat="server" colspan="1" class="text-right font-weight-600" style="border: 2px solid; display:none;">0</th>
                    ...
                    <th id="tot_row_igst" runat="server" colspan="2" class="text-right font-weight-600" style="border: 2px solid">0.00</th>
                          ...
                          <th id="tot_row_Amt_tax" runat="server" colspan="1" class="text-right font-weight-600" style="border: 2px solid"></th>
                      </tr>
                         <tr>
