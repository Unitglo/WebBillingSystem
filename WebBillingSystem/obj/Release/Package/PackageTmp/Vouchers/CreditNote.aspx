<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMainPage.Master" AutoEventWireup="true" CodeBehind="CreditNote.aspx.cs" Inherits="WebBillingSystem.CreditNote" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="hk-pg-header mb-10">
            <div>
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="book"></i></span></span>Credit Note</h4>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               <td colspan="1">Name  :</td>
                                                ...
                                                <%--<td> <i class="glyphicon glyphicon-plus" onclick="window.location='/Master/AddAccount?redirect=credit';"></i></td>--%>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
                                                    <hr class="mt-0">
                                        ...
                                        <tbody>
                                           ...
                                           <tr class="tr_gst_Id">
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td><input type="button" class="btn btn-primary" value="Add" onclick="addproduct()" data-toggle="tooltip-dark" data-placement="top" title="Add Record In List"></td>
				...
				<!-- #Product Add -->
                  ...
                  <table class="table table-light table-bordered mb-0 table-responsive" id="myTable"
						...
						<tr>
                            ...
                            <th style="border: 2px solid;" colspan="3">TOTAL</th>
        ...
        <div class="row">
                                <div class="col-sm">
                                    ...
                                    <button type="button" id="btnVerCentMod" class="btn btn-primary example-modal-center" onclick="btnClick()" data-toggle="modal" data-target="#exampleModalCenter" data-placement="top" title="Save Credit Note">Save</button>
                                    <asp:Button runat="server" class="btn btn-info" type="" id="btnPrint" text="Print" OnClick="btnPrintClick" data-toggle="tooltip-dark" data-placement="top" title="Print Data Credit Note"/>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <asp:Button runat="server" class="btn btn-primary" type="submit" id="submit_account_details" text="Save Changes" OnClick="submit_account_details_event" data-toggle="tooltip-dark" data-placement="top" title="Save Credit Note"/>
                                                  </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="modalYesClick" tabindex="-1" role="dialog" aria-labelledby="modalYesClick" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary btn_No_Class" onclick="window.location.href = '/Vouchers/CreditDetails.aspx';">NO</button>
  ...
  window.onload = function () {
        ...
        select1_options();
        settingsCheck();
        if($('[id*=breadcrumb_title]').text() == "Update Credit Note") {
            SETVALUE();
            updateval();
            ...
            var prodcutObject = JSON.parse('<%=json_product%>');
...
//Pay Status onclick Check mode change         
...
//Save onclick add values in total hidden feild        
        function btnClick() {
...
//Set values details controls and add table
         function updateval() {            
...
//Add Product in Table with validation        
        function addproduct() {
            ...
            if ($("[id*=txtproduct_name]").val() == "") {
                ...
                $('#myTable> tbody:last').append('<tr>'+
                    ...
                    '<td colspan="3" style="border:1px solid!important;" class="tot_class">' + tot + '</td>' +
        ...
        function editRow(row) {
            ...
            $("[id*=txtQty]").val(qty);
            //$("[id*=txtAmount]").val($(tr).find('td:eq(8)').text());
...
//for delete product in table
 ...
 //Save Button Onclick Check Validation
...
//Create JSON in Save values(Details Table) and Set values(redirect)
...
//Reset Onclick All Value Clear        
        ...
        function create_json_mst() {
         ...
         function AccountBtnOnClick() {
            ...
            window.location.href = window.location='/Master/AddAccount?redirect=credit';
         }
        ...
        function StockBtnOnClick() {
            ...
            localStorage.setItem('items', $(".txthdn_Json").val());
            localStorage.setItem('items1', jsonStr);
            window.location.href = window.location='/Master/AddStock?redirect=credit';
        }
        ...
        function setAllValuesClick(id) {
         ...
         function yesClick() {
            ...
            var values = {};
                ...
                var json_str = JSON.stringify(JSONObject); 
            window.location.href = window.location = '/Master/AddAccount?redirect=credit&editId=<%=Request.QueryString["value"] %>&val=' + json_str;
         }
