<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMainPage.Master" AutoEventWireup="true" CodeBehind="SalesOrder.aspx.cs" Inherits="WebBillingSystem.SalesOrder" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 80%;">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="SupplierNameList" runat="server" AutoPostBack="True" Width="150">
                    <asp:ListItem Text="Select Any Customer" Value="0">Select Any Customer</asp:ListItem>
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <!-- can't Change -->
                <asp:DropDownList ID="DropDownList11" runat="server" Width="150">
                    <asp:ListItem Text="Select Mode" Value="0"></asp:ListItem>
                    <asp:ListItem Text="Cash" Value="Cash"></asp:ListItem>
                    <asp:ListItem Text="By Hand" Value="By Hand"></asp:ListItem>
                    <asp:ListItem Text="By Cheque" Value="By Check"></asp:ListItem>
                </asp:DropDownList>
                <!-- can't Change -->
