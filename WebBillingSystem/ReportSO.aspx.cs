...
{
    public partial class ReportSO : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!Page.IsPostBack){
                dbObject.CreateList(DropDownList1, dbObject.TableSalesOrder, new String[] { "sales_order_id", "sales_order_id" });
            }
        }
       ...
       protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
       {
           ...
           reader.Close();
           GridView1.DataSource = dbObject.SelectAllValues(dbObject.TableSalesItems, " where sales_order_id=" + DropDownList1.SelectedValue);
           GridView1.DataBind();
       }
