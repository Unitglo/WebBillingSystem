<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMainPage.Master" AutoEventWireup="true" CodeBehind="PurchaseReturn.aspx.cs" Inherits="WebBillingSystem.PurchaseReturn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            ...
            <li runat="server" class="breadcrumb-item active" aria-current="page" id="breadcrumb_title">Add Purchase Return</li>
        </ol>
    </nav>
    <!-- /Breadcrumb -->
    <div class="container">
        ...
        <div class="hk-pg-header mb-10">
            <div>
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="book"></i></span></span>Purchase Return</h4>
                            ...
                            <div class="col-md-6 mb-20">
                                <h6 class="mb-5">
                                    <table style="width: 100%; text-align: left;">
                                        <tbody>
                                             <tr>                                              
                                               <td colspan="2">Against invoice <i onclick="show_invoice()"></i> : </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-20">
                                <h6 class="mb-5">
                                    <table style="width: 100%; text-align: left;">
                                        <thead style="text-align:center; border:groove;">
                                            <th><input type="checkbox" id="chk_Id" onclick=' if($(this).prop("checked")){ $(".ship_Party_Address").text(""); $(".shipPartygstin").val("0"); $(".ship_Party_state").text(""); $(".ship_Party_state_code").text(""); $(".seller_name").val($(".bill_party_name").val()).change();trclick($(".Bill_Party_index").val(),"seller_name");}'></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="1">Name :</td>
                                                <td colspan="3" style="max-width: 10px;">
            ...
            <%--<div class="col-xl-12">--%>       
                                    ...
                                    <table style="width: 100%; text-align: left;">
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td><input type="button" id="addproduct_id" runat="server" class="btn btn-primary" value="Add" onclick="addproduct()" data-toggle="tooltip-dark" data-placement="top" title="Add In Table"></td>
				...
				<!-- #Product Add -->
                  ...
                  <table class="table table-light table-bordered mb-0 table-responsive" id="myTable"
                     ...
                     <tr>
                            <th colspan="10" class="text-center font-weight-600" style="border-left: 2px solid"></th>
                      ...
                      <tr style="height:100px">
                            <th colspan="6" class="text-center font-weight-600" style="border: 2px solid; vertical-align: text-top;">Terms and Conditions 
                              ...
                              <th colspan="2" class="text-center font-weight-600" style="border: 2px solid; vertical-align: bottom;">Common Seal</th>
        ...
        <!-- end row -->
                              <div class="row">
                                <div class="col-sm">
                                    ...
                                    <button type="button" id="btnVerCentMod" class="btn btn-primary example-modal-center" onclick="btnClick()" data-toggle="modal" data-target="#exampleModalCenter" data-placement="top" title="Save Purchase Return">Save</button>
                                    <asp:Button runat="server" class="btn btn-info" type="" id="btnPrint" text="Print" OnClick="btnPrintClick" data-toggle="tooltip-dark" data-placement="top" title="Print Data in Purchase Return"/>
                                    ...
                                    <div class="modal fade" id="modalYesClick" tabindex="-1" role="dialog" aria-labelledby="modalYesClick" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary btn_No_Class" onclick="window.location.href = '/Vouchers/DebitDetails.aspx?purRetu=Purchase Return';">NO</button>
    ...
    window.onload = function () {
        ...
        select_options();
        select1_options();
        if($('[id*=breadcrumb_title]').text() == "Update Purchase Return"){
        ...
        function convert_qty() {
           ...
           var data_cover_fact_selected = convert_number($(".unit_of_measure_class option:selected").attr('data-conversion-factor'));
           var uom_pri = $(".unit_of_measure_class option").eq(1).val();
           var qunty = convert_number($("[id*=txtQty]").val()); 
        ...
        function btnClick(){
            $(".total_totalamt").val(convert_number($("#tot_amt_add_cgst").text()));
        ...
        function CalculateTotal(){
            ...
            var Total = (convert_number(amount)*convert_number(qty));
            if(Total){
                $(".total").text(Total);
            }else
            {
        ...
        $("#btnVerCentMod").click(function () { 
           ...
           if($("[id*=againstinvoice]").val() =="0" || $("[id*=againstinvoice]").val() == null || $("[id*=againstinvoice]").val() == ""){
        ...
        function create_json_mst() {
         ...
         function AccountBtnOnClick() {
            ...
            window.location.href = window.location='/Master/AddAccount?redirect=PurchaseReturn';
         }
        ...
        function StockBtnOnClick() {
            ...
            localStorage.setItem('items', $(".txthdn_Json").val());
            localStorage.setItem('items1', jsonStr);
            window.location.href = window.location='/Master/AddStock?redirect=PurchaseReturn';
        }
      ...
      function setAllValuesClick(id) {
            ...
            for (var i = 0; i < count; i++) {
                if (p_json_obj1[i]['invoice_no'] == id) {
                    ...
                    trclick($(".bill_party_name option:selected").attr("data-index"), "bill_party_name");
                    //$(".bill_party_name").trigger('change.select2');
        ...
        function yesClick() {
            ...
            var values = {};
                ...
                var json_str = JSON.stringify(JSONObject); 
            window.location.href = window.location = '/Master/AddAccount?redirect=PurchaseReturn&editId=<%=Request.QueryString["value"] %>&val=' + json_str;
        }
