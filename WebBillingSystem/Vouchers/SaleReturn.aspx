<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMainPage.Master" AutoEventWireup="true" CodeBehind="SaleReturn.aspx.cs" Inherits="WebBillingSystem.SaleReturn" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- Breadcrumb -->
    <nav class="hk-breadcrumb" arica-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            <li class="breadcrumb-item"><a href="#">Pages</a></li>
            <li runat="server" class="breadcrumb-item active" aria-current="page" id="breadcrumb_title">Add Sale Return</li>
        </ol>
    </nav>
    <!-- /Breadcrumb -->
    <div class="container">
        ...
        <div class="hk-pg-header mb-10">
            <div>
                <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="book"></i></span></span>Sale Return</h4>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td colspan="2" style="max-width:20px;"><label id="doc_no" class="doc-no" runat="server"></label>
                                                    <select runat="server" class="form-control select2  cr_no_class"  id="cr_no_id" name="cr_no_name" >
                                                    </select>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <input type="date" runat="server" id="dateIssue" name="dateIssue" class="form-control date_Issue"/>
                                                </td>
                                        ...
                                        <tbody>
                                             <tr>
                                                ...
                                                <td colspan="2" style="max-width:20px;"> 
                                                    <select runat="server" class="form-control select2  against_invoice" id="againstinvoice" name="against-invoice">
                                                    </select>
                                                </td>
                                               </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <input type="date" runat="server" id="dateInvoice" name="dateInvoice" class="form-control date_Invoice" />
                                                </td>
                                            </tr>
                                             <tr>
                                                <td colspan="4">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               <td colspan="1">Name  :</td>
                                                ...
                                                <td colspan="2"><i class="glyphicon glyphicon-plus" onclick="AccountBtnOnClick()"></i></td>
                                                <%--<td colspan="2"> <i class="glyphicon glyphicon-plus" onclick="window.location='/Master/AddAccount?redirect=credit';"></i></td>--%>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
                                                    <hr class="mt-0">
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">:
                                                    <%--<label runat="server" id="billPartygstin" name="billPartygstin" class="billParty_gstin"></label>--%>
                                    ...
                                    <table style="width: 100%; text-align: left;">
                                        <tbody>
                                            <tr>
								                ...
								                <td colspan="3"><input type="text" runat="server" id="txtproduct_name" name="product-name" class="form-control mt-15 product-name" placeholder="Product Desc" ></td>
                                    ...
                                    <table style="width: 100%; text-align: left;">
                                        <tbody>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                            <td><input type="button" class="btn btn-primary" value="Add" onclick="addproduct()" data-toggle="tooltip-dark" data-placement="top" title="Add Record In Table"></td>
				...
				<!-- #Product Add -->
                  ...
                  <table class="table table-light table-bordered mb-0 table-responsive" id="myTable"
						...
						<tr>
							...
							<th style="border: 2px solid;" colspan="3">Action</th>
						</tr>
                            </thead>
                      ...
                      <tr>
                          <th id="tot_tot" colspan="4" class="text-center font-weight-600" style="border: 2px solid"><b>total</b></th>
        ...
        <!-- end row -->
                              ...
                              <div class="row">
                                <div class="col-sm">
                                    ...
                                    <button type="button" id="btnVerCentMod" class="btn btn-primary example-modal-center" onclick="btnClick()" data-toggle="modal" data-target="#exampleModalCenter" data-placement="top" title="Save Sale Return">Save</button>
                                    <asp:Button runat="server" class="btn btn-info" type="" id="btnPrint" text="Print" OnClick="btnPrintClick" data-toggle="tooltip-dark" data-placement="top" title="Print data Sale Return"/>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <asp:Button runat="server" class="btn btn-primary" type="submit" id="submit_account_details" text="Save Changes" OnClick="submit_account_details_event" data-toggle="tooltip-dark" data-placement="top" title="Save data"/>
                                                  </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="modalYesClick" tabindex="-1" role="dialog" aria-labelledby="modalYesClick" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary btn_No_Class" onclick="window.location.href = '/Vouchers/CreditDetails.aspx?saleRetu=Sale Return';">NO</button>
    ...
    window.onload = function () {
        ...
        if($('[id*=breadcrumb_title]').text() == "Update Sale Return"){
            SETVALUE();
            updateval();
        ...
        if(ser_id == "1"){
            $(".hdnDOC_class").val($(".cr_no_class option:selected").val());
        } else {
        ...
        function SETVALUE() {
            ...
            var jsonSettings = '<%=json_credit_obj %>';
            var p_json_obj = JSON.parse(jsonSettings);
            
            $(".against_invoice").val(p_json_obj[0]['against_invoice']);
            $(".against_invoice").trigger('change');
        ...
        function settingsCheck() {
            ...
            for(var i = 0; i < count; i++){
                ...
                ser_id = p_json_obj[i]['prefix_generate_credit_no'];
                if(p_json_obj[i]['batch_wise_details'] == "1"){
                    ...
                    //document.getElementById("tot_tot").colSpan = "4";
                    //$("[id*=tot_Dis]").show();
                    //$("[id*=tot_Taxval]").show();
                }
                ...
                if (p_json_obj[i]['expiry_details_tax_invoice'] == "1") {
                    ...
                    document.getElementById("foot_tot").colSpan = "5";
                    $("[id*=tot_Dis]").show();
                    $("[id*=tot_Taxval]").show();
                }
        ...
        function btnClick() {     
            ...
            $(".notetype").val("saleReturn");            
        }
        
         function updateval() {
            
            jsonPurchase = '<%=json_cr_obj %>';
            ...
            for(var i = 0; i < count; i++){                
                ...
                if (p_json_obj[i]['igst_amount'] == 0) {
                    //                       alert("hi")
                    $(".chkcgst_class").prop('checked', true);
                    $(".chkigst_class").prop('checked', false);
                    $(".txtCgst_class").val(p_json_obj[i]['cgst_amount']).show();
                    ...
                    $(".txtIgst_class").val(p_json_obj[i]['igst_amount']).show();
                    $("#tot_Igst").show();
                }
        ...
        function addproduct() {
            ...
            //}             
                ...
                $('#myTable> tbody:last').append('<tr>'+
                    ...
                    '<td style="border:1px solid!important;" class="batchClass">'+ (Date.parse($(".Batch_class").val())?$(".Batch_class").val():"0001-01-01")+'</td>'+
                    ...
                    '<td colspan="3" style="border:1px solid!important;"><i class="fa fa-pencil" style="font-size:25px;color:#17a2b8" aria-hidden="true" onclick="editRow(this), removeRow(this)"></i><i class="fa fa-close" name="record" style="font-size:30px;color:red" aria-hidden="true" onclick="removeRow(this)"></i>'
                    + '</tr>'               
                  ); 
        ...
        $("#btnVerCentMod").click(function() { 
            ...
            if (ser_id == "0") {                
                ...
                if ($(".cr_no_class").text() == "" || $(".cr_no_class").text() == "0") {
                    warning_message("Please Select Invoice No...!!");
                    return false;
                } else  if($("[id*=againstinvoice]").val() =="0" || $("[id*=againstinvoice]").val() == null || $("[id*=againstinvoice]").val() == ""){
                warning_message("Please Select against invoice...!!");
        ...
        function create_json() {
             var JSONObject = new Array();
                ...
                $('#myTable tbody tr').each(function(row, tr){
                     var values = {};
                    if(ser_id == "1"){
                        values.INVOICENO =  $(".cr_no_class option:selected").text();
                    } else {
                        values.INVOICENO =  $(".doc-no").text();
                    }                    
                    values.SELLER_NM = $(".against_invoice option:selected").text();
                    ...
                    if($(".bill_state_code").text() == $(".docState").text())
                    {                        
                ...
                if(ser_id == "1"){
                    var str = $(".cr_no_class option:selected").text();
                    var rest = str.substring(0, str.lastIndexOf("/") + 1);
                    $('[id*=series_id').val(str);                    
                    $(".hdn_doc_class").val($(".cr_no_class option:selected").text());
                }
                else{
        ...
        function create_json_mst() {
         ...
         function AccountBtnOnClick() {
            ...
            window.location.href = window.location='/Master/AddAccount?redirect=SaleReturn';
         }
        ...
        function StockBtnOnClick() {
            ...
            localStorage.setItem('items', $(".txthdn_Json").val());
            localStorage.setItem('items1', jsonStr);
            window.location.href = window.location='/Master/AddStock?redirect=SaleReturn';
        }

        //Against Invoice onclick Set values All Controls and Table
      function setAllValuesClick(id) {
            ...
            jsonSaleMstValue = '<%=json_sale_setvalue_mst_obj %>';
            ...
            for (var i = 0; i < count; i++) {
                if (p_json_obj1[i]['invoice_no'] == id) {
                    ...
                    $(".bill_party_name").val(p_json_obj1[i]['seller_name']).trigger('change');
                    ...
                    $(".seller_name").val(p_json_obj1[i]['ship_party_name']).trigger('change');
                    $(".ship_Party_Address").html(p_json_obj1[i]['ship_party_address']);
                    $(".shipPartygstin").val(p_json_obj1[i]['ship_party_gstin']);
                    $(".ship_Party_state").html(p_json_obj1[i]['ship_party_state']);
                    $(".ship_Party_state_code").html(p_json_obj1[i]['ship_party_state_code']);
                }
            }

           jsonSaleValue = '<%=json_sale_setvalue_dtl_obj %>';
        ...
        function yesClick() {
            ...
            var values = {};
                ...
                var json_str = JSON.stringify(JSONObject); 
            window.location.href = window.location = '/Master/AddAccount?redirect=SaleReturn&editId=<%=Request.QueryString["value"] %>&val=' + json_str;
        }
