...
namespace WebBillingSystem
{
    public partial class SaleReturn : System.Web.UI.Page
    {
        ...
        {
            breadcrumb_title.InnerHtml = "Add Sale Return";
            ...
            if (Request.QueryString["value"] != null && Request.QueryString["delete"] != null)
            {
                ...
                {
                    Response.Redirect("~/Vouchers/CreditDetails.aspx?saleRetu='Sale Return'");
                }
            }
            ...
            else
            {
                if (!Page.IsPostBack)
                {
                    breadcrumb_title.InnerHtml = "Update Sale Return";
