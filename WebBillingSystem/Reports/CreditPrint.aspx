<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreditPrint.aspx.cs" Inherits="WebBillingSystem.CreditPrint" %>
  ...
  <nav class="hk-breadcrumb" aria-label="breadcrumb">
    ...
    <div class="container">
        ...
        <div class="hk-pg-header mb-10">
            <div>
                <h4 class="hk-pg-title" runat="server" id="Header_ID"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="book"></i></span></span>Credit Note</h4>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td colspan="2">:<label id="doc_no" class="doc-no" runat="server"></label>
                                                    <select runat="server" class="form-control select2 select2-hidden-accessible cr_no_class"  id="cr_no_id" name="cr_no_name" >
                                                    </select>
                                                </td>
                            ...
                            <div class="col-md-6 mb-20">
                                <h6 class="mb-5">
                                    <table style="width: 100%; text-align: left;">
                                        <tbody>
                                             <tr>
                                                 <td colspan="2" style="width: 20%;">Against invoice <i class="glyphicon glyphicon-search" onclick="show_invoice()"></i> : </td>
                                                <td colspan="2"> 
        ...
        function addproduct() {
            ...
            //}
                ...
                if($(".doc-code").text() == $(".bill_state_code").text())
                {
                    ...
                    $(".totalgst").val(parseFloat(tot_cgst_amt)+parseFloat(tot_sgst_amt));
                    ...
                    $("#tot_add_sgst").text(0);
                    $("#tot_amt_add_cgst").text(tot_amount_tax);
                    $(".totalgst").val(parseFloat($("#tot_add_igst").text()));
