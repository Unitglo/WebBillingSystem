...
{
    public partial class DebtorsStatement : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //MySqlDataReader acc_head_drop = baseHealpare.SelectAllValues(baseHealpare.TableAddAccount, "  WHERE account_main_group = '5' AND account_sub_group = '3' AND status != 2");
