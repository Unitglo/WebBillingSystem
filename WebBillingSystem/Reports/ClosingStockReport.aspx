                        ...
                        <table id="ClosingStockLedger" class="table table-hover w-100 pb-30 dataTable dtr-inline table-bordered" role="grid">
                            <thead>
						        <tr>
							        ...
							        <th colspan="1" data-orderable="false" style="border: 2px solid; text-align:center; width:350px;">Group</th>
							        <th colspan="1" data-orderable="false" style="border: 2px solid; text-align:center; width:200px;"> Product Name </th>
							        <th colspan="3" data-orderable="false" style="border: 2px solid; text-align:center; width:200px;">Closing Balance</th>
							    </tr>
                                <tr>
...
<script type="text/javascript">
    ...
    // main function 
     ...
     function stock_details_display() {         
         ...
         //<td></td><td></td>
         table.row.add($('<tr style="font-weight: bold;"><td></td><td></td><td></td><td></td><td></td><td></td></tr>')[0]).draw();
         ...
         $('#ClosingStockLedger tbody tr').find("td:eq(2)").css("text-align", "center");
        ...
        // $('#ClosingStockLedger tbody tr').find("td:eq(7)").css("text-align", "right");
         ...
         $('#ClosingStockLedger tbody tr:eq(0) td:eq(2)').html('');
         $('#ClosingStockLedger tbody tr:eq(0) td:eq(3)').html('<label id="op_bal_qty_id" runat="server">0.00</label>');
         $('#ClosingStockLedger tbody tr:eq(0) td:eq(4)').html("");
         $('#ClosingStockLedger tbody tr:eq(0) td:eq(5)').html('<label id="op_bal_val_id" runat="server">0.00</label>');
    ...
    function format(obj) {
        ...
        if (jsonStringDtl != '') {
            ...
            if (obj[0] < 1) {
                ...
                op_balance = $("#ClosingStockLedger tbody tr.RowClass").eq(obj[0]).find("td:eq(3)").html();      
         ...
         var name_val = '<div class="'+ d.month +'"><table class="table table-hover dataTable" id="dtl_Table" cellpadding="5" cellspacing="0" border="0" style="padding-left:50px; width: 100%;">';
             ...
             jsonStringDtl.forEach(function (key, index) {              
                 if (key.month == d.month) {                    
                     var rate = key.cl_bal_value / key.cl_bal_qty;
                    name_val += '<tr id="table_tr_id">' +
                        ...
                        '<td style="text-align: right; width: 100px;">' + key.party_name + '</td>' +
